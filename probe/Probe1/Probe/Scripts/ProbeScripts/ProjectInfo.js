...
//Update Form Fields
    ...
    function fieldChanged(field) {
        ...
        console.log($("#projectInfoForm").serialize() + "&changedField=" + field.id)
        console.log(UpdProjInfoUrl)
        console.log(444)
...
//Update ActivityStatus
            ...
            function approvalStatusChanged(obj) {
                    ...
                    $("#dialog-message").dialog({
                        ...
                        buttons: {
                            "Yes": function () {
                                var ud = {}
                                ud.projectID = ProjID
                                url = "/Probe/Home/UpdateProjectApprovalStatus"
                                $.ajax({
                                    url: url,
                                    type: "POST",
                                    data: ud,
                                    ...
                                    $('#dialog-message').dialog("close");
                                    location.href = "/Probe/Home/SelectedProject/?id="+ud.projectID+"&fromList=Proposed"
                                    console.log(65665)
                                })
                    ...
                    var msg = "Are you sure you want to change the status back to Proposed? This cannot be undone.";
                    $('#dialog-message').dialog('option', 'title', 'Change Approval Status');
                    document.getElementById('dialog-message').innerHTML = "<p><span class='ui-icon ui-icon-alert' style='float:left; margin:0 7px 20px 0;'></span>" + msg + "</p>";
