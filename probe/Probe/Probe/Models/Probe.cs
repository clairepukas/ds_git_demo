...
namespace Probe.Models
{
    public class ProjectInfo
    {
        ...
        public List<ProjectInfoBudget> ProposedBudgetList { get; set; }

        [DisplayName("Proposed Total")]
        public Nullable<decimal> ProposedTotal { get; set; }
        [DisplayName("Proposed Expense")]
        public Nullable<decimal> ProposedExpense { get; set; }

        [DisplayName("Proposed E to P")]
        public Nullable<decimal> ProposedEtoP { get; set; }

        [DisplayName("Proposed Capital")]
        ...
        public string ServiceAgreementVendorName { get; set; }
        public Nullable<int> ServiceAgreementVendorId { get; set; }
        ...
        public List<string> ProjectGroupList { get; set; }
        public List<string> ProjectGroupListIndex { get; set; }

        public List<projectAttachments> attachmentGroups { get; set; }
        ...
        public string Display_Project_Info { get; set; }
        public Nullable<bool> TerminateServiceAgreementAlert { get; set; }

        public string update_Field_Info { get; set; }
    ...
    public class NewProj
    {
        ...
        public int ServiceAgreementVendorId { get; set; }
    ...
    public class ServiceAgreementVendors
    {
        public string ServiceAgreementVendorName { get; set; }
    ...
    public class BudgetViewRecord
    {
        ...
        public decimal BudgetedTotal { get; set; }
    ...
    public class tableMaintenanceTypes
    {
        ...
        public string BudgetStatus { get; set; }
        public string BudgetType { get; set; }
        public string CostSavingsTypes { get; set; }
        public int CostSavingsTypeId { get; set; }
        public string EntityType { get; set; }
        public string ActivityStatus { get; set; }
        public string ApprovalStatus { get; set; }
        ...
        public int BenefitGroupOrder { get; set; }
        public string DocumentType { get; set; }
        public string BudgetStatusDisplayed { get; set; }
        public string ImpactName { get; set; }
        public string ImpactDesc { get; set; }
        public string TemplateType { get; set; }
        public string ProjectType { get; set; }
        ...
        public short weeks_duration { get; set; }
    ...
    public partial class ProbeData : DataContext
    {
        ...
        public List<int> AddProjectTwoOutputs_Template(string ProjectName, string BudgetNum, string Scope, string Comments, string Customer, string ProjectType, DateTime? ProposedStart, DateTime? ProposedEnd, string updateBy, int ProjectId, int UserId, string serviceAgreements, DateTime? SAExpirationdate)
        {
            List<int> ret = new List<int>();
            try
            {
            ...
            try
            {
                switch (changedField)
                {
                        ...
                        if (oldModel.DisplayName != model.DisplayName && !string.IsNullOrEmpty(model.DisplayName))
                        {
                            ...
                            using (SqlConnection cn = new SqlConnection(cnStr))
                            {
                                using (SqlCommand cmd = new SqlCommand("probe_UpdProjects", cn))
                                {
                                    ...
                                    SqlParameter warrantyAgreeType = new SqlParameter();
                                    warrantyAgreeType.ParameterName = "@ServiceAgreementType";
                                    if (model.warrantyAgreement == "Unknown")
                                    {
                                        model.warrantyAgreement = null;
                                    }

                                    warrantyAgreeType.Value = model.warrantyAgreement;
                                    warrantyAgreeType.SqlDbType = SqlDbType.VarChar;
                                    cmd.Parameters.Add(warrantyAgreeType);


                                    SqlParameter warrantyAgreeDate = new SqlParameter();
                                    warrantyAgreeDate.ParameterName = "@ServiceAgreementExpDt";
                                    warrantyAgreeDate.Value = model.warrantyAgreementDate;
                                    warrantyAgreeDate.SqlDbType = SqlDbType.DateTime;
                                    cmd.Parameters.Add(warrantyAgreeDate);
                                    

                                    SqlParameter Justification = new SqlParameter();
                                    Justification.ParameterName = "@Justification";
                                    Justification.Value = model.Justification;
                                    Justification.SqlDbType = SqlDbType.VarChar;
                                    cmd.Parameters.Add(Justification);


                                    SqlParameter terminateAgreement = new SqlParameter();
                                    terminateAgreement.ParameterName = "@TerminateServiceAgreementAlert";
                                    terminateAgreement.Value = model.TerminateServiceAgreementAlert;
                                    terminateAgreement.SqlDbType = SqlDbType.Bit;
                                    cmd.Parameters.Add(terminateAgreement);
                        ...
                        if (oldModel.BudgetNum != model.BudgetNum && !string.IsNullOrEmpty(model.BudgetNum))
                        {
                            ...
                            using (SqlConnection cn = new SqlConnection(cnStr))
                            {
                                using (SqlCommand cmd = new SqlCommand("probe_UpdProjects", cn))
                                {
                                    ...
                                    SqlParameter comx = new SqlParameter();
                                    comx.ParameterName = "@Comments";
                                    comx.Value = model.Comments;
                                    comx.SqlDbType = SqlDbType.VarChar;
                                    cmd.Parameters.Add(comx);
                    ...
                    case "Manager":
                        ...
                        {
                            ProbeUser mgr = GetUser(oldModel.Manager);
                            int o = mgr.UserId;
                            ret = DelProjectUserRole(model.ProjectId, mgr.UserId, "Manager");
                            msg = "Project Manager changed from " + oldModel.Manager + " to blank";
                            log = AddChangeLog(model.ProjectId, DateTime.Now, userId, msg, ref newLogId);
                        }
                        break;
                    ...
                    case "Sponsor":
                        ...
                        }else if (model.Sponsor == null)
                        {
                            ProbeUser mgr = GetUser(oldModel.Sponsor);
                            int o = mgr.UserId;
                            ret = DelProjectUserRole(model.ProjectId, mgr.UserId, "Sponsor");
                            msg = "Project Sponsor changed from " + oldModel.Sponsor + " to blank";
                            log = AddChangeLog(model.ProjectId, DateTime.Now, userId, msg, ref newLogId);
                        }
                        break;
                    ...
                    case "Engineer":
                        ...
                        else if (model.Engineer == null)
                        {
                            ProbeUser mgr = GetUser(oldModel.Engineer);
                            int o = mgr.UserId;
                            ret = DelProjectUserRole(model.ProjectId, mgr.UserId, "Engineer");
                            msg = "Project Engineer changed from " + oldModel.Engineer + " to blank";
                            log = AddChangeLog(model.ProjectId, DateTime.Now, userId, msg, ref newLogId);
                        }
                        break;
                        ...
                        if (oldModel.Scope != model.Scope)
                        {
                            ...
                            using (SqlConnection cn = new SqlConnection(cnStr))
                            {
                                using (SqlCommand cmd = new SqlCommand("probe_UpdProjects", cn))
                                {
                                    ...
                                    SqlParameter warrantyAgreeVendorID = new SqlParameter();
                                    warrantyAgreeVendorID.ParameterName = "@ServiceAgreementVendorId";
                                    warrantyAgreeVendorID.Value = model.ServiceAgreementVendorId;
                                    warrantyAgreeVendorID.SqlDbType = SqlDbType.Int;
                                    cmd.Parameters.Add(warrantyAgreeVendorID);
                    ...
                    case "Comments":
                        if (oldModel.Comments != model.Comments)
                        {
                            string cnStr = WebConfigurationManager.ConnectionStrings["probedb"].ConnectionString;
                    ...
                    case "TerminateServiceAgreementAlert":
                        if (model.TerminateServiceAgreementAlert == true)
                        {
                    ...
                    case "Justification":
                        if (model.Justification=="" || model.Justification!="")
                        {
        ...
        public int addProjectAttachment(int ProjectId, string AttachmentTitle, byte[] AttachmentBinary, string FileType, string updateBy, int newProjectAttachmentId)
        {
            string cnStr = WebConfigurationManager.ConnectionStrings["probedb"].ConnectionString;
            using (SqlConnection cn = new SqlConnection(cnStr))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("probe_AddProjectAttachments", cn))
                {
                    ...
                    SqlParameter ATid = new SqlParameter();
                    ATid.ParameterName = "@AttachmentgroupId";
                    ATid.Value = newProjectAttachmentId;
                    ATid.SqlDbType = SqlDbType.Int;
        ...
        public IEnumerable<ProjectAttachments> GetProjectAttachments(int projectId)
        {
            ...
            var sql = @"SELECT ProjectAttachmentId
                          ...
                          ,FileType
                          ,createdDt
                          ,ProjectAttachments.AttachmentGroupId
                          ,AttachmentGroups.AttachmentGroupName
                      FROM ProjectAttachments left join
                        AttachmentGroups on ProjectAttachments.AttachmentGroupId=AttachmentGroups.AttachmentGroupId
                      where ProjectId = {0}";
        ...
        public IEnumerable<projectAttachments> GetProjectAttachmentsGroup()
        {

            var sql = @"SELECT *
                      FROM AttachmentGroups";

            IEnumerable<projectAttachments> results = this.ExecuteQuery<projectAttachments>(sql);
            return results;
        }



        public IEnumerable<AttachmentGroup> GetProjectAttachmentsGroup_()
        {

            var sql = @"SELECT *
                      FROM AttachmentGroups order by AttachmentGroupName asc";

            IEnumerable<AttachmentGroup> results = this.ExecuteQuery<AttachmentGroup>(sql);
            return results;
        }

        public IEnumerable<ServiceAgreementVendors> GetVendorsAdmin()
        {
            var sql = @"SELECT * FROM ServiceAgreementVendors order by ServiceAgreementVendorName asc";
            IEnumerable<ServiceAgreementVendors> results = this.ExecuteQuery<ServiceAgreementVendors>(sql);
            return results;
        }


        public  ServiceAgreementVendors GetVendor(int id)
        {
            
            try
            {
                //int fr = id.ServiceAgreementVendorId;
                var sql = @"SELECT * FROM ServiceAgreementVendors where ServiceAgreementVendorId="+id;
                IEnumerable<ServiceAgreementVendors> results = this.ExecuteQuery<ServiceAgreementVendors>(sql);
                return results.FirstOrDefault();
            }
            catch(Exception ex)
        ...
        //Update vendors
        [FunctionAttribute(Name = "probe_UpdServiceAgreementVendors")]
        public int upDateVendors(int ServiceAgreementVendorId, string ServiceAgreementVendorName, string updateBy)
        {
            try
            {
                
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ServiceAgreementVendorId, ServiceAgreementVendorName, updateBy);
                return (int)result.ReturnValue;
            }
            catch(Exception ex)
            {
        ...
        //INSERT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_AddServiceAgreementVendors")]
        public int AddVendors(string ServiceAgreementVendorName, string updateBy, int ServiceAgreementVendorId)
        {
            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ServiceAgreementVendorName, updateBy, ServiceAgreementVendorId);
                return (int)result.ReturnValue;
        ...
        //Delete~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_DelServiceAgreementVendors")]
        public int DeleteVendors(int ServiceAgreementVendorId, string updateBy )
        {
            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ServiceAgreementVendorId, updateBy);
                return (int)result.ReturnValue;
        ...
        public string GetTemplateHTML(string url)
        {
            ...
            foreach (var item in templates)
            {
                ...
                string testString = item.TemplateFileName;
                if (testString.Contains("Excel") || testString.Contains("Microsoft") || testString.Contains("MS Project"))
                {
                    html += "<p style='padding-left:35px;'><a " + disabletxt + " href='" + url + "Home/doTemplateDownload?templateFileName=" + item.TemplateFileName + "&templateType=" + item.TemplateType + "'>" + item.TemplateFileName + "</a></p>";
                }
                else
                {
                    html += "<p><a " + disabletxt + " href='" + url + "Home/doTemplateDownload?templateFileName=" + item.TemplateFileName + "&templateType=" + item.TemplateType + "'>" + item.TemplateFileName + "</a></p>";
        ...
        public ProjectInfo GetProjectInfo(int projectId)
        {
            ...
            ,p.ActualStart
            ,p.ActualEnd 
            ,p.TerminateServiceAgreementAlert
            ,p.pct_complete
            ,p.InitApproved
            ,p.ServiceAgreementType
            ,sav.ServiceAgreementVendorId
           ,sav.ServiceAgreementVendorName
            FROM Projects   p
            left
            join ServiceAgreementVendors     sav
            on   p.ServiceAgreementVendorId = sav.ServiceAgreementVendorId
            where p.ProjectId = {0}";
        ...
        public ProjectInfo GetProjectInfo1(int projectId, string name)
        {
            var sql = @"SELECT       p.ProjectId
            ,p.ProjectNumber
            ,p.ProjectName
        ...
        where p.ProjectId = {0}";
            ...
            try
            {
                IEnumerable<ProjectInfo> results = this.ExecuteQuery<ProjectInfo>(sql, projectId,name);
                return results.FirstOrDefault();
            }
            catch (Exception ex)
            {
        ...
        [FunctionAttribute(Name = "probe_UpdProjectConfig")]
        public int configupdate(int ProjectId, string ConfigType, string ConfigValue, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, ConfigType, ConfigValue, updateBy);
            return (int)result.ReturnValue;
        ...
        [FunctionAttribute(Name = "probe_AddProjectConfig")]
        public int configAdd(int ProjectId, string ConfigType, string ConfigValue, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, ConfigType, ConfigValue, updateBy);
            return (int)result.ReturnValue;
        ...
        [FunctionAttribute(Name = "probe_UpdProjects")]
        public int UpdateProjectRecord(int ProjectId, string ServiceAgreementType, string updateBy, string Scope, string Comments, string ProjectType, DateTime? ProposedStart, string Customer, DateTime? ProposedEnd, DateTime? ServiceAgreementExpDt, [Parameter(Name = "ServiceAgreementVendorId", DbType = "Int")] ref System.Nullable<Int32>  ServiceAgreementVendorId, int UserId, bool? TerminateServiceAgreementAlert, DateTime? ProjectedStart, DateTime? ProjectedEnd, DateTime? ActualStart, DateTime? ActualEnd)
        {
            int g = 7;
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(cnStr))
                {
                    using (SqlCommand cmd = new SqlCommand("probe_UpdProjects", cn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@ServiceAgreementVendorId", ServiceAgreementVendorId);
                        cmd.Parameters.AddWithValue("@TerminateServiceAgreementAlert", TerminateServiceAgreementAlert);
                        cmd.Parameters.AddWithValue("@updateBy", updateBy);


                        cmd.Parameters.AddWithValue("@ProjectedStart", ProjectedStart);
                        cmd.Parameters.AddWithValue("@ProjectedEnd", ProjectedEnd);
                        cmd.Parameters.AddWithValue("@ActualStart", ActualStart);
        ...
        [FunctionAttribute(Name = "probe_UpdProjectBenefits")]
        public int probe_UpdProjectBenefits(int ProjectID, int BenefitId, int BenefitValue, int BenefitLevel, string updateBy)
        {
            try
            {

                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectID, BenefitId, BenefitValue, BenefitLevel, updateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception e)
            {
...
ProjectId ={0}";
        ...
        public NewProj getVendorInfo(int projectId)
        {

            var sql = @"Select * from ServiceAgreementVendors where ServiceAgreementVendorId ={0}";
            try
            {
                IEnumerable<NewProj> results = this.ExecuteQuery<NewProj>(sql, projectId);
                return results.FirstOrDefault();
        ...
        public List<ChangeLog_set> GetProjectsLogs(int interv)
        {
            try
            {
                DateTime time = DateTime.Now;
                string format = "yyyy-M-dd 00:00:00";
                DateTime time1 = time.AddDays(interv);
                string g = time1.ToString(format);
                var sql = @"SELECT c.ProjectId
                        ,c.LogId
                        ,c.LogDt
                        ,c.LogMsg
                        ,p.ProjectName
                        ...
                        where  c.LogDt >  Convert(datetime, '" + g + "') order by c.LogDt desc";



                IEnumerable<ChangeLog_set> results = this.ExecuteQuery<ChangeLog_set>(sql);
                return results.ToList<ChangeLog_set>();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<ProjectInfoBudget> getApprovedTotalBudgetCost(int projectId)
        {
            try
            {


                var sql=  @"select BudgetType,BudgetedTotal,ProjectedTotal,ActualTotal,ProposedTotal
                ...
                return results.ToList<ProjectInfoBudget>(); 
            ...
            catch (Exception ex)
            {
                ...
                public List<ProjectInfoBudget> getTotalBudgetCost(int projectId)
        {
            try
            {

                //var sql = @"SELECT Projected as Projectedtotal,Budgeted as BudgetedTotal,Actual as ActualTotal, CurrentBudgetAmount as tot FROM ProjectBudgetsDetailsWTotals_v WHERE ProjectId = {0} and BudgetType='Totals' ";
                /*var sql = @"SELECT 
SUM(CASE WHEN BudgetStatus='Budgeted'  THEN Amount END) BudgetedTotal
,SUM(CASE WHEN BudgetStatus='Projected' THEN Amount END) ProjectedTotal
,SUM(CASE WHEN BudgetStatus='Actual'    THEN Amount END) ActualTotal
,SUM(CASE WHEN BudgetStatus='Proposed'  THEN Amount END) ProposedTotal
...
FROM   ProjectBudgets WHERE ProjectId = {0} ";*/
...
where  ProjectId = {0}";
        ...
        public ProjectInfoBudget GetProjectInfoBudget(int projectId)
        {
           /* var sql1 = @"SELECT BudgetedTotal
            ...
            var sql = @"select BudgetType, ProposedTotal, BudgetedTotal, ProjectedTotal    
       , ActualTotal from ProjectBudgetsDetailsWTotals_v where  ProjectId = 362 order by order_by, BudgetType desc";
        ...
        //UPDATE~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_UpdProjectAttachments")]
        public int UpdAttachmentGroups(int ProjectAttachmentId, int ProjectId, string AttachmentTitle, string AttachmentType, Byte[] AttachmentBinary, string FileType, string updateBy, int AttachmentGroupId)
        {
            try
            {


                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectAttachmentId, ProjectId, null, null, null, null, updateBy, AttachmentGroupId);
                return (int)result.ReturnValue;
            }
            catch (Exception ex)
            {
        ...
        //INSERT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_AddProjectPhaseTasks")]
        public int AddProjectPhaseTasks(int ProjectId, int PhaseId, string TaskTitle, DateTime? StartDate, DateTime? EndDate, int pct_complete, string updateBy, [Parameter(Name = "TaskId", DbType = "Int")] ref System.Nullable<Int32> TaskId)
        {

            try
            {

                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, PhaseId, TaskTitle, StartDate, EndDate, pct_complete, updateBy, TaskId);
                return (int)result.ReturnValue;
            }catch(Exception ex)
            {
                throw ex;
        ...
        //Edit~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_UpdProjectPhaseTasks")]
        public int UpdProjectPhaseTasks(int ProjectId, int PhaseId, int TaskId, string TaskTitle,  DateTime? StartDate, DateTime? EndDate, int pct_complete, string updateBy)
        {

            try
            {

                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, PhaseId, TaskId, TaskTitle, StartDate, EndDate, pct_complete, updateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception ex)
            {
        ...
        //Delete~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_DelProjectPhaseTasks")]
        public int deleteProjectPhaseTasks(int ProjectId, int PhaseId, int TaskId,string UpdateBy)
        {

            try
            {

                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, PhaseId,  TaskId, UpdateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception ex)
            {
        ...
        public int AddProjectBenefit(int ProjectId, int BenefitId, int BenefitValue, int BenefitLevel, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, BenefitId, BenefitValue, BenefitLevel, updateBy);
            return (int)result.ReturnValue;
        }
        ...
        public List<NewProj> GetVendorLists()
        {
            try
            {
                string sql = @"SELECT * from ServiceAgreementVendors order by ServiceAgreementVendorName asc";
                IEnumerable<NewProj> results = this.ExecuteQuery<NewProj>(sql);
                return results.ToList<NewProj>();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<BudgetViewRecord> GetBudgetsDetailsWTotalsRecords(int ProjectId)
        {
            try
            {
                /*var sql1 = @"select BudgetType,Budgeted,Projected,Actual,CurrentBudgetAmount
                            from ProjectBudgetsDetailsWTotals_v
                            where ProjectId = {0}
                            order by BudgetType";*/
              var  sql = @"select BudgetType, ProposedTotal     
       , BudgetedTotal, ProjectedTotal, ActualTotal
from   ProjectBudgetsDetailsWTotals_v where  ProjectId = {0} order by BudgetType";
        ...
        [FunctionAttribute(Name = "probe_UpdProjects")]
        public int roleBackApprovalStatus(int ProjectId, string ApprovalStatus, string ActivityStatus, DateTime? ProjectedStart, DateTime? ProjectedEnd, string UpdateBy)
        {
            try
            {


                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, ApprovalStatus, ActivityStatus, ProjectedStart, ProjectedEnd, UpdateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception e)
            {
        ...
        [FunctionAttribute(Name = "probe_DelProjectBudgets")]
        public int roleBackProjectBudgets(int ProjectId, string DelALLdata, string UpdateBy)
        {
            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, DelALLdata, UpdateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception e)
            {
        ...
        [FunctionAttribute(Name = "probe_DelProjectPhases")]
        public int roleBackProjectPhases(int ProjectId, int PhaseId, string DelALLdata, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, PhaseId, DelALLdata, updateBy);
            return (int)result.ReturnValue;
        }
        ...
        [FunctionAttribute(Name = "probe_UpdProjectBudgets")]
        public int UpdOriginalProjectBudgets(int ProjectId, string BudgetType, decimal CurrentBudgetAmount, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, BudgetType, CurrentBudgetAmount, updateBy);
            return (int)result.ReturnValue;
        }
                    ...
                    if (pinfo.ApprovalStatus == "Proposed")
                    {
                        if (pinfo.ActivityStatus.ToLower() == "pending")
                        {
                            if (usr.ProjectRoleList.Contains("Creator") ||
                                ...
                                usr.ProjectRoleList.Contains("Contributor")
                                )
                            {
                                hasEdit = true;
                            }
        ...
        public IEnumerable<BenefitGroups> GetBenefitGroupsData()
        {
            try
            {
                var sql = @"SELECT [BenefitGroupId]
                              ,[BenefitGroupName]
                              ,[BenefitGroupOrder]
                          FROM [BenefitGroups] order by BenefitGroupName asc";
        ...
        public int AddBenefitGroups(string BenefitGroupName, int BenefitGroupOrder, string updateBy, int BenefitGroupId)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), BenefitGroupName, BenefitGroupOrder, updateBy, BenefitGroupId);
            return (int)result.ReturnValue;
        }
        ...
        public int AddBenefits(string BenefitName, int BenefitGroupId, string updateBy, int BenefitId)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), BenefitName, BenefitGroupId, updateBy, BenefitId);
            return (int)result.ReturnValue;
        }
        ...
        public int AddBudgetStatuses(string BudgetStatus, string updateBy, string BudgetStatusDisplayed)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), BudgetStatus, updateBy, BudgetStatusDisplayed);
            return (int)result.ReturnValue;
        }
        ...
        //INSERT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_AddAttachmentgroups")]
        public int AddAttachMentGroup(string AttachmentGroupName, string updateBy, int AttachmentGroupId)
        {
            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), AttachmentGroupName, updateBy, AttachmentGroupId);
                return (int)result.ReturnValue;
            }
            catch (Exception ex)
            {
        ...
        public int AddCostSavingsTypes(string CostSavingsType, string updateBy, int CostSavingsTypeId)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), CostSavingsType, updateBy, CostSavingsTypeId);
            return (int)result.ReturnValue;
        }
        ...
        [FunctionAttribute(Name = "probe_AddGroups")]
        public int _AddGroups(string GroupName, string updateBy, [Parameter(Name = "GroupId", DbType = "Int")] ref System.Nullable<Int32> GroupId)
        {
            try
            {
                int? NewId = -1;
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), GroupName, updateBy, 14);
                int newid = int.Parse(result.GetParameterValue(3).ToString());
        ...
        [FunctionAttribute(Name = "probe_CheckProjectPermissions")]
        public int verifyDeptAdmin(int ProjectId, string updateBy, [Parameter(Name = "permisson_flg", DbType = "Int")] ref System.Nullable<Int32> permisson_flg, [Parameter(Name = "permisson_msg", DbType = "varchar(300)")] ref string permisson_msg)
        {
            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ProjectId, updateBy, permisson_flg, permisson_msg);
                string newid1 = result.GetParameterValue(2).ToString();
                string newid2 = "";
                //string permisson_msg1 = result.GetParameterValue(3).ToString();
                if (newid1 == "0")
                {
                    newid2 = result.GetParameterValue(3).ToString();
                }
                return Int32.Parse(newid1);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public IEnumerable<Impacts> GetImpactsData()
        {
            try
            {
                var sql = @"SELECT [ImpactId]
                            ,[ImpactName]
                            ,[ImpactDesc]
                          FROM [Impacts] order by ImpactName asc";
        ...
        public int AddImpacts(string ImpactName, string ImpactDesc, string updateBy, int ImpactId)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ImpactName, ImpactDesc, updateBy, ImpactId);
            return (int)result.ReturnValue;
        }
        ...
        public IEnumerable<Phases> GetPhasesData()
        {
            try
            {
                var sql = @"SELECT [PhaseId]
                            ...
                            ,[color]
                            ,[weeks_duration]
                          FROM [Phases] order by PhaseName asc";
        ...
        [FunctionAttribute(Name = "probe_UpdPhases")]
        public int UpdWarranty(int PhaseId, string PhaseName, string PhaseDesc, int PhaseOrder, string color, Int16 weeks_duration, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), PhaseId, PhaseName, PhaseDesc, PhaseOrder, color, weeks_duration, updateBy);
            return (int)result.ReturnValue;
        }
        ...
        public int AddPhases(string PhaseName, string PhaseDesc, int PhaseOrder, string color, string updateBy, int PhaseId)
        {

            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), PhaseName, PhaseDesc, PhaseOrder, color, updateBy, 8);
            return (int)result.ReturnValue;
        }
        ...
        #endregion
        #region ProjectTypes
        public List<ProjectTypes> GetProjectTypesData()
        {
            try
            {
                ...
                return results.ToList<ProjectTypes>();
        ...
        public IEnumerable<serviceTypes> GetServiceTypesData()
        {
            try
            {
                var sql = @"SELECT [ServiceAgreementType]
                          FROM [ServiceAgreementTypes] ";

                IEnumerable<serviceTypes> results = this.ExecuteQuery<serviceTypes>(sql, "");
                return results;
            }
            catch (Exception ex)
            {
        ...
        public serviceTypes ServiceAgreementType(serviceTypes recobj)
        {
            try
            {
                var sql = @"SELECT [ServiceAgreementType]
                          FROM [ServiceAgreementType] ";



                IEnumerable<serviceTypes> results = this.ExecuteQuery<serviceTypes>(sql, "");
                return results.FirstOrDefault<serviceTypes>();
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<projectAttachments> getAttachmentGroups()
        {
            try
            {
                var sql = @"SELECT *
        ...
        //INSERT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_AddServiceAgreementTypes")]
        public int AddServiceAgreementTypes(string ServiceAgreementType, string updateBy)
        {

            try
            {
                IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ServiceAgreementType, updateBy);
                return (int)result.ReturnValue;
            }
            catch (Exception e)
            {
        ...
        ////DELETE~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_DelServiceAgreementTypes")]
        public int DelServiceAgreementTypes(string ServiceAgreementType, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ServiceAgreementType, updateBy);
            return (int)result.ReturnValue;
        }
        ...
        public AttachmentGroup GetAttachmentGroupRecord(AttachmentGroup recobj)
        {
            try
            {
                var sql = @"SELECT *
                          FROM [AttachmentGroups] ";
                sql += " where AttachmentGroupId = '" + recobj.AttachmentGroupId + "'";


                IEnumerable<AttachmentGroup> results = this.ExecuteQuery<AttachmentGroup>(sql, "");
                return results.FirstOrDefault<AttachmentGroup>();
            }
            catch (Exception ex)
            {
                //logEntry(new Logging.log("Error", "GetTemplateTypesRecord. : " + ex.ToString()));
        ...
        ////DELETE~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        [FunctionAttribute(Name = "probe_DelAttachmentGroups")]
        public int DelAttachmentGroup(int AttachmentGroupId, string updateBy)
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), AttachmentGroupId, updateBy);
            return (int)result.ReturnValue;
        }
        ...
        [FunctionAttribute(Name = "probe_UpdProjectBudgetStartOver")]
        public int budgetRollBack(int ProjectId, string updateBy)
        {
            try
            {
