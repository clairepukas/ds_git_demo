    ...
    public class HomeController : Controller
    {
        ...
        public JsonResult rollbackBudget(ProjectInfo mod)
        {
            try
            {
                ...
                int h = data.budgetRollBack(mod.ProjectId, "estes");
        ...
        public JsonResult UpdateProjectData(ProjectInfo mod)
        {
            ...
            try
            {
                ...
                if (mod.warrantyAgreementDate==null)
                {
                    ...
                    if (mod.ServiceAgreementVendorId==0)
                    {
                        int? newId=null;
                        h = data.UpdateProjectRecord(mod.ProjectId, mod.warrantyAgreement, usr.UserName, oldModel.Scope, oldModel.Comments, oldModel.ProjectType, oldModel.ProposedStart, oldModel.Customer, oldModel.ProposedEnd, null, ref newId, usr.UserId);
                    }
                ...
                else
                {
                    ...
                    h = data.UpdateProjectRecord(mod.ProjectId, mod.warrantyAgreement, usr.UserName, oldModel.Scope, oldModel.Comments, oldModel.ProjectType, oldModel.ProposedStart, oldModel.Customer, oldModel.ProposedEnd, dt, ref newId, usr.UserId);
                }*/
                ...
                h = data.UpdateProjectRecord(mod.ProjectId, mod.warrantyAgreement, usr.UserName, oldModel.Scope, oldModel.Comments, oldModel.ProjectType, oldModel.ProposedStart, oldModel.Customer, oldModel.ProposedEnd, dt, ref newId, usr.UserId, mod.TerminateServiceAgreementAlert);
