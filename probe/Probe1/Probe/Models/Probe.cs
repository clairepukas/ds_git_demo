...
namespace Probe.Models
{
    ...
    public partial class ProbeData : DataContext
    {
        ...
        {
            var sql = @"SELECT * FROM ServiceAgreementVendors";
...
ProjectId ={0}";
        ...
        public List<ChangeLog_set> GetProjectsLogs(int interv)
        {
            try
            {
                ...
                var sql = @"SELECT c.ProjectId
                        ...
                        left join Users u on u.UserId=c.ProjectId
                        where c.LogMsg like '%Status%' and c.LogDt >  Convert(datetime, '" + g + "') order by c.LogDt desc";
        ...
        public List<NewProj> GetVendorLists()
        {
            try
            {
                string sql = @"SELECT * from ServiceAgreementVendors";
